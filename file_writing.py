...
def read_file(file_name):
    ...
    with open(file_name, encoding='utf-8') as f_n:  # open(file_name) as f_n:
        f_n_reader = DictReader(f_n)
...
def delete_file():
    with open('phone.csv', 'r', encoding='utf-8') as fn:
        lines = fn.readlines()
    with open('phone.csv', "w") as fn:
        for line in lines:
            if line.strip("\n") != 'Ivan,Ivanov,12345678901':
                fn.write(line)
